    ...
    def _dummy_run(
        ...
        with self.synchronize_input_prep():
            ...
            if force_attention or cudagraph_runtime_mode == CUDAGraphMode.FULL:
                ...
                # Populate buffers so that GDN attention triggers JIT
                # compilation of spec-decode path before graph capture.
                # Without this, Triton kernels in _forward_core (e.g.
                # causal_conv1d_update) will attempt cuModuleLoadData
                # during stream capture, which CUDA forbids.
                if (
                    uniform_decode
                    ...
                    self.num_accepted_tokens.np[:num_reqs] = max_query_len
                    self.num_accepted_tokens.np[num_reqs:].fill(0)
                    self.num_accepted_tokens.copy_to_gpu()
